...
if (\PHP_VERSION_ID >= 80100) {
     ...
     *
     * This is the PHP 8.1+ tier of the polyfill. The public API mirrors the
     * Time\Duration class introduced in PHP 8.6. All arithmetic is delegated
     * to Phuture\Continuum\Time\DurationMath so that validation and overflow
     * guarding live in a single place.
     *
     ...
     * handler that only the internal class possesses.
     *
    ...
    final class Duration
    {
         ...
         *
         * Declared first so it sorts before the nanosecond component. The
         * value is re-derived from the public triple on every access through
         * DurationMath, so writes to the public properties (which readonly
         * prevents on this tier) cannot desynchronise it.
         *
         * @var int
         */
        private readonly int $comparableSeconds;
         ...
         * @var int
         */
        private readonly int $comparableNanoseconds;
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::fromSeconds($seconds, $nanoseconds));
        }
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::fromNanoseconds($nanoseconds));
        }
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::fromMicroseconds($microseconds));
        }
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::fromMilliseconds($milliseconds));
        }
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::fromMinutes($minutes));
        }
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::fromHours($hours));
        }
 ...
 * @throws \Time\TimeException If the string is invalid or the result overflows
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::fromIso8601DurationString($specification));
        }
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::negate([
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::absolute([
                'seconds' => $this->seconds,
                'nanoseconds' => $this->nanoseconds,
                'negative' => $this->negative,
            ]));
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::add(
                [
                    'seconds' => $this->seconds,
                    'nanoseconds' => $this->nanoseconds,
                    'negative' => $this->negative,
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::subtract(
                [
                    'seconds' => $this->seconds,
                    'nanoseconds' => $this->nanoseconds,
                    'negative' => $this->negative,
 ...
 * @throws \Time\TimeException If the result exceeds the representable range
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::multiplyBy(
                [
                    'seconds' => $this->seconds,
                    'nanoseconds' => $this->nanoseconds,
                    'negative' => $this->negative,
 ...
 * @throws \ValueError If divisor is not positive
        ...
        {
            return new self(...\Phuture\Continuum\Time\DurationMath::divideBy(
                [
                    'seconds' => $this->seconds,
                    'nanoseconds' => $this->nanoseconds,
                    'negative' => $this->negative,
 ...
 * @param self $b The right operand
        ...
        {
            return \Phuture\Continuum\Time\DurationMath::compare(
                [
                    'seconds' => $a->seconds,
