...
use Phuture\Continuum\Uri\{InvalidUriException, UriComparisonMode};
...
class Uri
{
     ...
     * @param string $uri The URI string to parse
     * @param self|null $baseUrl Optional base URI for resolving relative references
     * @return self|null Returns null if the URI cannot be parsed
     */
    public static function parse(string $uri, ?self $baseUrl = null): ?self
    {
        try {
